...
import com.phantomx.worldgenerator.geom.Rectangle;
import com.phantomx.worldgenerator.voronoi.groundshapes.HeightAlgorithm;
import com.phantomx.worldgenerator.voronoi.nodename.as3delaunay.LineSegment;
...
public abstract class VoronoiGraph {
    ...
    private Voronoi applyLloydRelaxations(Voronoi v, int numLloydRelaxations) {
    ...
    private void buildGraph(Voronoi v) {
        ...
        final ArrayList<com.phantomx.worldgenerator.voronoi.nodename.as3delaunay.Edge> libedges = v.edges();
        final HashMap<Integer, Corner> pointCornerMap = new HashMap();

        for (com.phantomx.worldgenerator.voronoi.nodename.as3delaunay.Edge libedge : libedges) {
